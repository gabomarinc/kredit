...
export const WhatsBlastTab: React.FC<WhatsBlastTabProps> = ({ prospects: sourceProspects }) => {
    ...
    useEffect(() => {
        setCurrentPage(1);
    }, [searchTerm, activeFilters, viewFilter, useExcel, uploadedProspects]);
            ...
            <div className="max-w-7xl mx-auto px-6 py-10">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-8 mt-12">
                    ...
                    <div className="flex items-center gap-3">
                        {/* ... (Upload Buttons - kept same) ... */}
                        {useExcel && (
                            <button onClick={() => { setUseExcel(false); setUploadedProspects([]); setActiveFilters({}); }} className="text-xs font-bold text-red-500 hover:bg-red-50 px-4 py-2.5 rounded-xl transition-colors">
                                Limpiar Excel
                            </button>
                        )}
